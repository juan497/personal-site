    ...
    <div>
      <div class="container">
        ...
        <div class="text-content">
          ...
          <p>This project gave me hands-on experience with computer networking, TCP sockets, concurrency, multithreading, synchronization, and routing algorithms. I particularly enjoyed seeing how networking and concurrency work together and would like to continue developing more projects that combine these areas.<a className='header__link' href="https://github.com/juan497/Distance-Vector-Routing-Protocol-Simulation/blob/main/DistanceVectorRoutingProtocolSimulation.py" >source code here</a></p>
        </div>
